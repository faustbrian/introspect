 ...
 */
class TestInstanceGrandchild extends TestInstanceChild
{
    public function grandchildMethod(): void {}
}

/**
 * Test class with trait usage.
 */
class TestInstanceWithTrait
{
 ...
 */
class TestInstanceWithInterface implements TestInstanceInterface
{
    public function interfaceMethod(): void {}
}
 ...
 */
class TestInstanceWithProperties
{
...
class TestInstanceWithAttribute {}

/**
 * Test class without trait.
 */
class TestInstanceWithoutTrait {}

/**
 * Test class without interface.
 */
class TestInstanceWithoutInterface {}

/**
 * Test class without parent class.
 */
class TestInstanceWithoutParent {}

/**
 * Test class without attribute.
 */
class TestInstanceWithoutAttribute {}

/**
 * Test class with multiple traits.
 */
class TestInstanceWithMultipleTraits
{
    use TestInstanceTrait;
 ...
 */
class TestInstanceWithMultipleInterfaces implements TestInstanceInterface, TestInstanceSecondInterface
{
    public function interfaceMethod(): void {}
 ...
 */
class TestInstanceComplex implements TestInstanceInterface
{
    use TestInstanceTrait;
 ...
 */
class TestInstanceWithoutPublicMethods
{
    private function privateMethod(): void {}
 ...
 */
class TestInstanceWithoutPublicProperties
{
    private string $privateProperty = 'private';
