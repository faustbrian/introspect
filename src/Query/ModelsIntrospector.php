...
final class ModelsIntrospector
{
    ...
    {
        $this->filters[] = function (string $model) use ($name): bool {
            /** @var class-string $model */
            return Reflection::hasProperty($model, $name);
        };
    ...
    {
        $this->filters[] = function (string $model) use ($names, $all): bool {
            /** @var class-string $model */
     ...
     *
     * @return bool True if at least one model matches
     */
     ...
     *
     * @return int Number of matching models
     */
     ...
     * @return bool         True if class extends Illuminate\Database\Eloquent\Model
     */
     ...
     *
     * Evaluates both main filters (AND logic) and OR filters to determine if a model matches.
     *
     * @param  string $model Fully-qualified model class name
     * @return bool   True if model matches filter criteria
     */
