...
## Example: Dynamic Property Setter
...
{
    public function setProperties(object $instance, array $data): object
    {
    ...
    public function setPropertiesSafe(object $instance, array $data, array $allowed): object
    {
        foreach ($data as $property => $value) {
